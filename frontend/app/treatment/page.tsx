                            ...
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                                                    ...
                                                    <div key={key} className="mb-3">
                                                        ...
                                                        <div className="w-full bg-white/10 rounded-full h-3 overflow-hidden">
                                                            <motion.div initial={{ width: 0 }} animate={{ width: `${value}%` }} transition={{ duration: 1 }}
                                                                className="bg-gradient-to-r from-[#C5757C] to-[#F9AAAD] h-3 rounded-full" />
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                                ...
                                <div className="mt-6 flex justify-end">
                                    <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                                        ...
                                        className="px-6 py-3 bg-gradient-to-r from-[#C5757C] to-[#F9AAAD] text-white font-semibold rounded-lg">
