                ...
                <div className="container mx-auto px-6 pt-20 pb-12 relative z-10">
                    ...
                    <div className="max-w-5xl mx-auto space-y-12">
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                            ...
                            <p className="text-gray-400 mb-6">Brain tumors account for 85–90% of all primary CNS tumors. Early detection is critical, but:</p>
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                            ...
                            <p className="text-gray-400 mb-6">The entire interface and generated reports are available in three languages:</p>
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                            ...
                            <p className="text-gray-400 mb-4">Expanding beyond brain tumors to detect tumors across the entire body:</p>
                            <div className="flex flex-wrap gap-3">
                                {['🫁 Lung Tumors', '🩻 Bone Tumors', '🔬 Liver & Abdominal', '📡 Pan-India Deployment', '🏛️ Government Integration'].map((item, i) => (
                                    <span key={i} className="px-4 py-2 bg-white/10 rounded-full text-white text-sm border border-white/10">{item}</span>
                                ))}
                            </div>
                        </motion.div>
                    </div>
